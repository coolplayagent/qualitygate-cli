...
- The 524-fixture corpus includes 85 policy-evolution cases. `tests/selfcheck.rs` requires unchanged goldens to detect weakened commit and policy evaluators, actual timeout/tool-error evidence, serial/parallel agreement, and isolated native Git setup.
