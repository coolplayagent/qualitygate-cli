...
The executable top-level owner contract and supported source forms are documented in [docs/en/03-architecture/03-development-view.md](docs/en/03-architecture/03-development-view.md). Run the architecture gate after changing module ownership or imports; keep its source-digest and file/line evidence reviewable.
