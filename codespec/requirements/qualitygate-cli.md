...
| SNAP-33-DELIVERY | Default delivery-line checks, explicit repository scope, policy-bound pre-acquisition exclusions, preserved command failures and packaged Skill trimming workflow | `tests/delivery_scope.rs`, `tests/quality.rs`, `application::report_gate::tests` |
